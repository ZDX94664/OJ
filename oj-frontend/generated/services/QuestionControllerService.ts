...
import type { BaseResponse_UserQuestionStats_ } from '../models/BaseResponse_UserQuestionStats_';
...
import type { BaseResponse_QuestionSuggestVO_ } from '../models/BaseResponse_QuestionSuggestVO_';
...
questionUpdateRequest: QuestionUpdateRequest,
    ...
    /**
     * getUserStats
     * @returns BaseResponse_UserQuestionStats_ OK
     * @throws ApiError
     */
    public static getUserStatsUsingGet(): CancelablePromise<BaseResponse_UserQuestionStats_> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @returns BaseResponse_QuestionSuggestVO_ OK
     * @throws ApiError
     */
    public static getRecommendQuestionsUsingGet(): CancelablePromise<BaseResponse_QuestionSuggestVO_> {
        return __request(OpenAPI, {
            method: 'GET',
